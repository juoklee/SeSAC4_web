...
where studygroup.head_id="juok" AND studygroup.study_id=2;
...
where U.user_id="juok" AND G.study_id=2;
...
-- 멤버인지 아닌지
SELECT * FROM studymember
WHERE study_id=2 AND user_id="sejun22";

-- 조장인지 아닌지
SELECT * FROM studygroup
WHERE study_id=2 AND head_id="juok";